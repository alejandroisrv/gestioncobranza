      ...
      <div slot="body">
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4"> Comisión: {{producto.comision}}</div>
          </div>
          <div class="row">
            <div class="col-md-4"> Precio a contado: {{ producto.precio_contado }} </div>
            <div class="col-md-4">Precio a crédito {{producto.precio_credito}} </div>
          </div>
        </div>
      </div>
      <div slot="footer">
