                          ...
                          <p style="font-size:18px">Selecciona el filtro</p>
                            <table class="table col-md-12">
                                <tr>
                                  ...
                                  <td class="td-select" v-if="operaciones.length > 0 "><v-select v-model="parametros.tipo" :options="operaciones" placeholder="Selecione el tipo"></v-select></td>
                                </tr>
                                <tr>
...
export default {
    ...
    data(){
        return{
        fecha:'Todas',
        operaciones:[{id:-1,label:'Salidas'},{id:1,label:'Entradas'}],
        parametros : {
            desde:'',
            hasta:'',
            tipo:undefined
    ...
    methods:{
        filtrar(){
            ...
            this.eventHub.$emit('SendFiltro',query);
